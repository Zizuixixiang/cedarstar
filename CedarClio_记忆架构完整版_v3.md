...
| `memory_get_summaries` | date, days, summary_type, starred_only, page, page_size（HTTP 层还可传 `session_kind`、`context_only` 等，与 Mini App 一致） | 分页查询 chunk 和日摘要，支持收藏过滤 | `GET /api/memory/summaries` |
