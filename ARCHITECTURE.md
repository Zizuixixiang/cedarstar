...
| `group_chat_max_message_chars` | Telegram 群聊每段字数上限（`format_telegram_group_segment_directive` 注入 system：日常严守、专业解答/吐槽分析/安慰等可酌情单行略超；每轮最多 3 段；发送端不截断；合法范围 10–3800） |
